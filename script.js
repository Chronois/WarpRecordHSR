...
const MASTER_CHARACTERS = {
  ...
  "himeko": { name: "Himeko", source: "Standard", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1102.png" },
  "welt": { name: "Welt", source: "Standard", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1103.png" },
  "yanqing": { name: "Yanqing", source: "Standard", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1106.png" },
  ...
  "aglaea": { name: "Aglaea", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1403.png" },
  "anaxa": { name: "Anaxa", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1405.png" },
  "archer": { name: "Archer", source: "Other", img: null },
  "argenti": { name: "Argenti", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1214.png" },
  "ashveil": { name: "Ashveil", source: "Limited", img: null },
  ...
  "blade": { name: "Blade", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1006.png" },
  "mortenax blade": { name: "Mortenax Blade", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1006.png" },
  "boothill": { name: "Boothill", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1314.png" },
  "castorice": { name: "Castorice", source: "Limited", img: null },
  "cerydra": { name: "Cerydra", source: "Limited", img: null },
  "cipher": { name: "Cipher", source: "Limited", img: null },
  "cyrene": { name: "Cyrene", source: "Limited", img: null },
  "dan heng • imbibitor lunae": { name: "Dan Heng • Imbibitor Lunae", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1217.png" },
  "dan heng • permansor terrae": { name: "Dan Heng • Permansor Terrae", source: "Limited", img: null },
  "dr. ratio": { name: "Dr. Ratio", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1304.png" },
  "evanescia": { name: "Evanescia", source: "Limited", img: null },
  "feixiao": { name: "Feixiao", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1319.png" },
  "firefly": { name: "Firefly", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1314.png" },
  ...
  "huohuo": { name: "Huohuo", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1215.png" },
  "hyacine": { name: "Hyacine", source: "Limited", img: null },
  "hysilens": { name: "Hysilens", source: "Limited", img: null },
  "jade": { name: "Jade", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1315.png" },
  ...
  "jing yuan": { name: "Jing Yuan", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1209.png" },
  "jingliu": { name: "Jingliu", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1213.png" },
  "kafka": { name: "Kafka", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1005.png" },
  "lingsha": { name: "Lingsha", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1320.png" },
  "luocha": { name: "Luocha", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1205.png" },
  "mydei": { name: "Mydei", source: "Limited", img: null },
  "phainon": { name: "Phainon", source: "Limited", img: null },
  "rappa": { name: "Rappa", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1321.png" },
  "robin": { name: "Robin", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1310.png" },
  "ruan mei": { name: "Ruan Mei", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1302.png" },
  "saber": { name: "Saber", source: "Other", img: null },
  "seele": { name: "Seele", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1201.png" },
  "silver wolf": { name: "Silver Wolf", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1305.png" },
  "silver wolf • lv. 999": { name: "Silver Wolf • Lv. 999", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1305.png" },
  ...
  "sparxie": { name: "Sparxie", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1306.png" },
  "sunday": { name: "Sunday", source: "Limited", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1401.png" },
  "the dahlia": { name: "The Dahlia", source: "Limited", img: null },
  "the herta": { name: "The Herta", source: "Limited", img: null },
  ...
  "tribbie": { name: "Tribbie", source: "Limited", img: null },
  "yao guang": { name: "Yao Guang", source: "Limited", img: null },

  // --- Trailblazer ---
  "trailblazer • destruction": { name: "Trailblazer • Destruction", source: "Other", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1001.png" },
  "trailblazer • preservation": { name: "Trailblazer • Preservation", source: "Other", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1002.png" },
  "trailblazer • harmony": { name: "Trailblazer • Harmony", source: "Other", img: "https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/character/1003.png" },
  "trailblazer • remembrance": { name: "Trailblazer • Remembrance", source: "Other", img: null },
  "trailblazer • elation": { name: "Trailblazer • Elation", source: "Other", img: null }
};
